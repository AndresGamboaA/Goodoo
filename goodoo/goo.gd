...
func initialize_presets():
	...
	presets["top-left"] = { anchors_preset = 0,clip_contents = true }
	presets["top-right"] = { anchors_preset = 1,clip_contents = true }
	presets["bottom-right"] = { anchors_preset = 2,clip_contents = true }
	presets["bottom-left"] = { anchors_preset = 3,clip_contents = true }
	presets["top-left"] = { anchors_preset = 4,clip_contents = true }
	presets["center-left"] = { anchors_preset = 5,clip_contents = true }
	presets["center-top"] = { anchors_preset = 6,clip_contents = true }
	presets["center-left"] = { anchors_preset = 7,clip_contents = true }
	presets["center-bottom"] = { anchors_preset = 8,clip_contents = true }
	presets["left-w"] = { anchors_preset = 9,clip_contents = true }
	presets["top-w"] = { anchors_preset = 10,clip_contents = true }
	presets["right-w"] = { anchors_preset = 11,clip_contents = true }
	presets["bottom-w"] = { anchors_preset = 12,clip_contents = true }
	presets["v-center-w"] = { anchors_preset = 13,clip_contents = true }
	presets["h-center-w"] = { anchors_preset = 14,clip_contents = true }
	presets["full"] = { anchors_preset = 15,clip_contents = true }
...
func nothing():
	return BasicComponent.new({visible=false}, "control", [])
